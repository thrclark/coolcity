					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
								...
								innerHtml = "<span class='ui-icon ui-icon-" + themeIcon + "'><span class='sr-only'>Select Month</span></span>";
							}
							else if (normalIcon && !options.theme) {
								innerHtml = "<span class='fc-icon fc-icon-" + normalIcon + "'><span class='sr-only'>Select Month</span></span>";
							}
							else {
